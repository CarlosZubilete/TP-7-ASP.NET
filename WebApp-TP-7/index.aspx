  ...
  <form id="form1" runat="server">
    ...
    <div class="containerMain">
      ...
      <div class="listProvincies">
        <asp:DataList ID="dataListProvincies" runat="server" DataSourceID="sqlSource_DBSucursales">
          <ItemTemplate>
      ...
      <div class="listStore">
        <%-- LIST VIEW --%>
        <asp:ListView ID="listViewSucursales" runat="server" DataSourceID="sqlSource_DBSucursales" GroupItemCount="3" DataKeyNames="Id_Sucursal">
          <EditItemTemplate>
...
<%-- Added the css class and class.cs for connection and queries --%>